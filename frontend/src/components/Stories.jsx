...
const Stories = () => {
  ...
  return (
    <div className="overflow-x-scroll no-scrollbar">
      <div className="flex space-x-2 lg:space-x-3 items-center px-4 py-8">
        <div className="flex flex-col justify-center items-center space-y-2">
          <div className="p-[4px] bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 rounded-full inline-block">
            {myStory ? (
              ...
              <button
                className="flex justify-center items-center md:h-16 md:w-16 lg:h-20 lg:w-20 rounded-full bg-base-100"
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  openStoryUploader();
